...
// store.dispatch({ type: 'ADD_REVIEW', id: temp_id0, text: "Johnny Ds was great!" });
// store.dispatch({ type: 'ADD_REVIEW', id: temp_id0, text: "Johnny Ds has the best wings!" });
// store.dispatch({ type: 'ADD_REVIEW', id: temp_id1, text: "I love their sushi!" });
// store.dispatch({ type: 'ADD_REVIEW', id: temp_id2, text: "Bring the family!" });
// store.dispatch({ type: 'ADD_REVIEW', id: temp_id3, text: "The grease does you good!" });
